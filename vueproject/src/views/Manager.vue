    ...
    <el-container>
      ...
      <el-aside :width="asideWidth" style="min-height: 100vh; background-color: #001529">
        <div style="height: 60px; color: white; display: flex;align-items: center;justify-content: center">
          ...
          <span class="logo-title" v-show="!isCollapse">lilac</span>
        </div>
          ...
          <div style="flex: 1; width: 0; display: flex;align-items: center;justify-content: flex-end">
            ...
            <el-dropdown placement="bottom">
              <div style="display: flex; align-items: center; cursor: default">
                <img :src="user.avatar" style="width: 50px; height: 50px; margin: 0 5px;border-radius: 50%">
                <span>{{user.name}}</span>
              </div>
...
export default {
  ...
  methods:{
    updateUser(user){ //获取子组件传过来的user
      this.user =   JSON.parse(JSON.stringify(user))
    },
    handleCollapse(){
      this.isCollapse = !this.isCollapse  //切换菜单menu收缩状态
